...
namespace app
{
	namespace credits
	{
		...
		static char text6[] = "-Example code collisions: Raylib";
		static char text9[] = "'Ball impact', Author: Kenney, 'https://www.kenney.nl/assets/impact-sounds' ";
		static char text10[] = "'Music', 'Beyond', Author: Patrik Patrikios, 'https://www.youtube.com/watch?v=uQUCXPZebos&ab_channel=NoCopyrightAudioLibrary'";
